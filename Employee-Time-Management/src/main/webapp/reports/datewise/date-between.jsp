...
<head>
 ...
 <%
     ...
     PreparedStatement ps=(PreparedStatement)application.getAttribute("datebetween");
      ps.setObject(1, ldate1);
      ps.setObject(2, ldate2);
     ResultSet rst=ps.executeQuery();
 %>
 <div class='dvv'>
     <label class='hdu'>Report of date between <%=TimeUtility.getDateFormater(d1) %> and <%=TimeUtility.getDateFormater(d2)%></label>
  </div>
     <div class="container">
